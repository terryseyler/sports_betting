...
class Forecast(models.Model):
    ...
    pressure = Imodels.ntegerField(default=0)
    ...
    weather_main = models.CharField(max_lenth = 200)
    weather_description = models.CharField(max_lenth = 200)
    ...
    df_txt = models.CharField(max_lenth = 200)
...
class GameSchedule(models.Model):
    ...
    stadium_name=models.ForeignKey(Stadiums,on_delete=CASCADE)

class Odds(models.Model):
    game_id = model.ForeignKey(GameSchedule,on_delete=CASCADE)
